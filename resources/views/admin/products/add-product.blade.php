...
<div class="row-fluid sortable">
	<div class="box span12">
		...
		<div class="box-content">
			<form class="form-horizontal" method="post" action="{{route('products.add-post')}}">
			{{csrf_field()}}
			  <fieldset>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="text" name="product_name" class="input-xlarge " id="">
				  </div>
				</div>
				<div class="control-group">
				...
				<div class="control-group hidden-phone">
				  ...
				  <div class="controls">
						...
						@foreach($brands as $brand)
							<option value="{{$brand->id}}">{{$brand->manufactor_name}}</option>
						@endforeach
						  </select>
				  </div>
				</div>
				...
				<label class="control-label" for="price">Product Price</label>
				  <div class="controls">
					<input type="text" name="product_price" class="input-xlarge" id="price">
				  </div>
				</div>
				...
				<label class="control-label" for="color">Product Color</label>
				  <div class="controls">
					<input type="text" name="product_color" class="input-xlarge" id="color">
				  </div>
				</div>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="text" name="product_size" class="input-xlarge" id="">
				  </div>
				</div>
				...
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="checkbox" name="publication_status" class="input-xlarge" id="Publication">
				  </div>
				</div>
